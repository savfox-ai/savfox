...
- [Command Execution](tools/exec.md)
- [Creating Skills](tools/creating-skills.md)
- [Plugin Development](tools/plugins.md)

# Automation

- [Hook System](automation/hooks.md)
- [Cron Service](automation/cron.md)

# Nodes

- [Overview](nodes/overview.md)
- [Device Pairing](nodes/pairing.md)
