#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $SAVFOX_HOME/skills."""
...
def _savfox_home() -> str:
    return os.environ.get("SAVFOX_HOME", os.path.expanduser("~/.savfox"))


def _tmp_root() -> str:
    base = os.path.join(tempfile.gettempdir(), "savfox")
    os.makedirs(base, exist_ok=True)
    return base


def _request(url: str) -> bytes:
    return github_request(url, "savfox-skill-install")
...
def _default_dest() -> str:
    return os.path.join(_savfox_home(), "skills")
