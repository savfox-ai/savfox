...
use anyhow::Result;
use savfox_windows_sandbox::{SetupErrorCode, SetupFailure};
...
const OFFLINE_BLOCK_RULE_NAME: &str = "savfox_sandbox_offline_block_outbound";

// Friendly text shown in the firewall UI.
const OFFLINE_BLOCK_RULE_FRIENDLY: &str = "Savfox Sandbox Offline - Block Outbound";
