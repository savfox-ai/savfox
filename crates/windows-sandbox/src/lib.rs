...
mod windows_impl {
    ...
    use super::acl::{add_allow_ace, add_deny_write_ace, allow_null_device, revoke_ace};
    use super::allow::{AllowDenyPaths, compute_allow_paths};
    ...
    use super::policy::{SandboxPolicy, parse_policy};
    use super::process::make_env_block;
    use super::token::convert_string_sid_to_sid;
    use super::winutil::{format_last_error, quote_windows_arg, to_wide};
    ...
    pub fn run_windows_sandbox_capture(
        ...
        ensure_savfox_home_exists(savfox_home)?;
