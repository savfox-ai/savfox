...
pub const SANDBOX_USERS_GROUP: &str = "SavfoxSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Savfox sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(savfox_home);
    ...
    let secrets_dir = sandbox_secrets_dir(savfox_home);
