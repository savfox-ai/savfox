...
pub use savfox_git::GhostSnapshotConfig;
...
pub async fn load_config_as_toml_with_cli_overrides(
    ...
    let merged_toml = config_layer_stack.effective_config();
    let cfg = deserialize_config_toml_with_base(merged_toml, savfox_home).map_err(|e| {
    ...
    fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            chatgpt_base_url: config_profile
                ...
                .unwrap_or("https://taidge.com/backend-api/".to_string()),
...
pub fn find_savfox_home() -> std::io::Result<PathBuf> {
    savfox_utils_home_dir::find_savfox_home()
}
    ...
    fn test_precedence_fixture_with_o3_profile() -> std::io::Result<()> {
        ...
        assert_eq!(
            Config {
                ...
                chatgpt_base_url: "https://taidge.com/backend-api/".to_string(),
