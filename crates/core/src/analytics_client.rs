...
use crate::git_info::{collect_git_info, get_git_repo_root};
...
async fn send_track_skill_invocations(auth_manager: &AuthManager, job: TrackEventsJob) {
    ...
    let url = format!("{base_url}/savfox/analytics-events/events");
...
mod tests {
    ...
    fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
        ...
        let skill_path = PathBuf::from("/repo/root/.savfox/skills/doc/SKILL.md");
        ...
        assert_eq!(path, ".savfox/skills/doc/SKILL.md");
    }

    #[test]
    fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
        let skill_path = PathBuf::from("/Users/abc/.savfox/skills/doc/SKILL.md");
    ...
    fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
        let skill_path = PathBuf::from("/etc/savfox/skills/doc/SKILL.md");
    ...
    fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
        let repo_root = PathBuf::from("/repo/root");
        let skill_path = PathBuf::from("/other/path/.savfox/skills/doc/SKILL.md");
