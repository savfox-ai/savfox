...
#[test]
fn trailing_savfox_generated_tokens_stop_at_first_non_generated_item() {
    ...
    assert_eq!(
        history.get_trailing_savfox_generated_items_tokens(),
        expected_tokens
    );
}
...
#[test]
fn total_token_usage_includes_only_trailing_savfox_generated_items() {
