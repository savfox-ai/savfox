...
/// The easiest way to iterate is to add unit tests and have Savfox fix the implementation.
/// To encourage this, the tests have been put directly below this function rather than at the
/// bottom of the
///
...
mod tests {
    ...
    fn supports_single_string_script_with_cd_and_pipe() {
        let inner =
            r#"cd /Users/pakrym/code/savfox && rg -n "savfox_api" savfox-rs -S | head -n 50"#;
        assert_parsed(
            &vec_str(&["bash", "-lc", inner]),
            vec![ParsedCommand::Search {
