...
fn detect_encoding(bytes: &[u8]) -> &'static Encoding {
    ...
    // - Windows-1252 reserving 0x80-0x9F for curly quotes/dashes: https://en.wikipedia.org/wiki/Windows-1252
...
mod tests {
    use encoding_rs::{
        BIG5, EUC_KR, GBK, ISO_8859_2, ISO_8859_3, ISO_8859_4, ISO_8859_5, ISO_8859_6, ISO_8859_7,
        ISO_8859_8, ISO_8859_10, ISO_8859_13, SHIFT_JIS, WINDOWS_874, WINDOWS_1250, WINDOWS_1251,
    ...
    fn test_windows_1252_privet_gibberish_is_preserved() {
        // Windows-1252 cannot encode Cyrillic; if the input literally contains "ÐŸÑ..." we should
        // not "fix" it.
    ...
    fn test_iso8859_3_south_europe_text() {
        ...
        // chardetng rarely distinguishes ISO-8859-3 from neighboring Latin code pages, so we rely
        // on an ASCII-only sample to ensure round-tripping still succeeds.
