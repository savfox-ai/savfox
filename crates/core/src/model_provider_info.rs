...
use savfox_api_client::provider::RetryConfig as ApiRetryConfig;
...
pub fn built_in_model_providers() -> HashMap<String, ModelProviderInfo> {
    ...
    [
        ...
        (
            "deepseek",
            create_cloud_chat_provider("DeepSeek", "https://api.deepseek.com", "DEEPSEEK_API_KEY"),
        ),
        (
            "mistral",
    ...
    fn to_api_provider_derives_savfox_api_models_base_url() {
        ...
        let api_provider = provider
            .to_api_provider(
                Some("openai"),
                Some(AuthMode::Chatgpt),
                Some("https://api.savfox.ai"),
            )
            .expect("convert provider");
        assert_eq!(api_provider.base_url, "https://api.savfox.ai/api/codex");
    }
