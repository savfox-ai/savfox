...
use savfox_protocol::models::{
    ...
    WebSearchAction, is_image_close_tag_text, is_image_open_tag_text,
    is_local_image_close_tag_text, is_local_image_open_tag_text,
};
    ...
    fn parses_agent_message() {
        ...
        match turn_item {
            TurnItem::AgentMessage(message) => {
                ...
                assert_eq!(text, "Hello from Savfox");
            }
