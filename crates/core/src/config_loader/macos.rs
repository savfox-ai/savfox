...
use super::config_requirements::{
    ConfigRequirementsToml, ConfigRequirementsWithSources, RequirementSource,
};

const MANAGED_PREFERENCES_APPLICATION_ID: &str = "com.openai.savfox";
