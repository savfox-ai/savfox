...
pub use savfox_protocol::models::SandboxPermissions;

use crate::exec::{
    ExecExpiration, ExecToolCallOutput, SandboxType, StdoutStream, execute_exec_env,
};
...
use crate::spawn::SAVFOX_SANDBOX_NETWORK_DISABLED_ENV_VAR;
    ...
    pub(crate) fn transform(
        ...
        let (command, sandbox_env, arg0_override) = match sandbox {
            ...
            SandboxType::MacosSeatbelt => {
                ...
                seatbelt_env.insert(SAVFOX_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
                let mut args =
            ...
            SandboxType::LinuxSeccomp => {
                let exe = savfox_linux_sandbox_exe
            ...
            // savfox-windows-sandbox crate. We leave the command unchanged here and
