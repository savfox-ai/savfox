...
use crate::analytics_client::{AnalyticsEventsClient, SkillInvocation, TrackEventsContext};
...
mod tests {
    ...
    fn make_skill(name: &str, path: &str) -> SkillMetadata {
        SkillMetadata {
            ...
            scope: savfox_protocol::protocol::SkillScope::User,
        }
    }
