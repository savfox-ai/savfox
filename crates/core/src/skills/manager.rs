...
use crate::config_loader::{CloudRequirementsLoader, LoaderOverrides, load_config_layers_state};
use crate::skills::SkillLoadOutcome;
use crate::skills::loader::{load_skills_from_roots, skill_roots_from_layer_stack_with_agents};
...
mod tests {
    ...
    use super::*;
    use crate::config::{ConfigBuilder, ConfigOverrides};

    fn write_user_skill(savfox_home: &TempDir, dir: &str, name: &str, description: &str) {
        let skill_dir = savfox_home.path().join("skills").join(dir);
    ...
    async fn skills_for_config_seeds_cache_by_cwd() {
        ...
        write_user_skill(&savfox_home, "b", "skill-b", "from b");
