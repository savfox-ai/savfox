...
use crate::truncate::{TruncationPolicy, approx_token_count, formatted_truncate_text};
use crate::unified_exec::async_watcher::{
    emit_exec_end_for_unified_exec, spawn_exit_watcher, start_streaming_output,
};
use crate::unified_exec::head_tail_buffer::HeadTailBuffer;
use crate::unified_exec::process::{OutputBuffer, OutputHandles, UnifiedExecProcess};
use crate::unified_exec::{
    ExecCommandRequest, MAX_UNIFIED_EXEC_PROCESSES, MAX_YIELD_TIME_MS, MIN_EMPTY_YIELD_TIME_MS,
    ProcessEntry, ProcessStore, UnifiedExecContext, UnifiedExecError, UnifiedExecProcessManager,
    UnifiedExecResponse, WARNING_UNIFIED_EXEC_PROCESSES, WriteStdinRequest, clamp_yield_time,
    generate_chunk_id, resolve_max_tokens,
};
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn write_stdin(
        ...
        // still alive or has exited and been removed from the store; we session
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        let spawn_result = if tty {
            savfox_utils_pty::pty::spawn_process(
                program,
                args,
                env.cwd.as_path(),
                &env.env,
            ...
            savfox_utils_pty::pipe::spawn_process_no_stdin(
                program,
                args,
                env.cwd.as_path(),
                &env.env,
    ...
    fn process_id_to_prune_from_meta(meta: &[(String, Instant, bool)]) -> Option<String> {
        ...
        lru.into_iter()
            .find(|(process_id, ..)| !protected.contains(process_id))
