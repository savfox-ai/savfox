...
use savfox_app_server_protocol::GitSha;
use savfox_protocol::protocol::GitInfo;
...
mod tests {
    ...
    async fn test_collect_git_info_detached_head() {
        ...
        // Should have commit hash
        assert!(git_info.commit_hash.is_some());
        // Branch should be None for detached HEAD (since rev-parse --abbrev-ref HEAD returns
        // "HEAD")
