...
use futures::Stream;
pub use savfox_api_client::common::ResponseEvent;
use savfox_protocol::models::{BaseInstructions, ResponseItem};
...
/// Review session system prompt. Edit `core/src/review_prompt.md` to customize.
...
pub(crate) mod tools {
    ...
    pub(crate) enum ToolSpec {
        ...
        LocalShell {},
        // TODO: Understand why we get an error on web_search although the API docs say it's
        // supported. https://platform.openai.com/docs/guides/tools-web-search?api-mode=responses#:~:text=%7B%20type%3A%20%22web_search%22%20%7D%2C
        // The `external_web_access` field determines whether the web search is over cached or
        // live content. https://platform.openai.com/docs/guides/tools-web-search#live-internet-access
...
mod tests {
    ...
    use savfox_api_client::common::{OpenAiVerbosity, TextControls};
    use savfox_api_client::{ResponsesApiRequest, create_text_param_for_request};
    ...
    fn serializes_text_schema_with_strict_format() {
        ...
        assert_eq!(
            format.get("name"),
            Some(&serde_json::Value::String("savfox_output_schema".into()))
        );
        assert_eq!(
            format.get("type"),
