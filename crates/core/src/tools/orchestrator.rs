...
use crate::tools::sandboxing::{
    ApprovalCtx, ExecApprovalRequirement, SandboxAttempt, SandboxOverride, ToolCtx, ToolError,
    ToolRuntime, default_exec_approval_requirement,
};
...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx<'_>,
        turn_ctx: &crate::savfox::TurnContext,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            savfox_linux_sandbox_exe: turn_ctx.savfox_linux_sandbox_exe.as_ref(),
        ...
        match tool.run(req, &initial_attempt, tool_ctx).await {
            ...
            Err(ToolError::Savfox(SavfoxError::Sandbox(SandboxErr::Denied { output }))) => {
                if !tool.escalate_on_failure() {
                    return Err(ToolError::Savfox(SavfoxError::Sandbox(
