...
/// - If the user approves for session, we store the decision for each key individually so future
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and savfox prompts the user to run
        /// outside the sandbox.
    ...
    NeedsApproval {
        ...
        /// Proposed execpolicy amendment to skip future approvals for similar commands
        /// See core/src/exec_policy.rs for more details on how proposed_execpolicy_amendment is
        /// determined.
        proposed_execpolicy_amendment: Option<ExecPolicyAmendment>,
    },
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub savfox_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
