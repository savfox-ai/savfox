...
use savfox_protocol::openai_models::{
    ConfigShellToolType, ModelInfo, ModelInstructionsVariables, ModelMessages, ModelVisibility,
    ModelsResponse, ReasoningEffort, ReasoningEffortPreset, TruncationPolicyConfig,
...
async fn remote_model_friendly_personality_instructions_with_feature() -> anyhow::Result<()> {
    ...
    let remote_slug = "savfox-remote-default-personality";
...
async fn user_turn_personality_remote_model_template_includes_update_message() -> anyhow::Result<()>
{
    ...
    let remote_slug = "savfox-remote-personality";
