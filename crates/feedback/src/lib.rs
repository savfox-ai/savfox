...
#[derive(Clone)]
pub struct SavfoxFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for SavfoxFeedback {
    fn default() -> Self {
        Self::new()
    }
}
...
impl SavfoxFeedback {
    ...
    pub fn snapshot(&self, session_id: Option<SessionId>) -> SavfoxLogSnapshot {
        let bytes = {
        ...
        SavfoxLogSnapshot {
            ...
            session_id: session_id
                .map(|id| id.to_string())
                .unwrap_or("no-active-session-".to_string() + &SessionId::new().to_string()),
        }
    }
}
...
pub struct SavfoxLogSnapshot {
    bytes: Vec<u8>,
    tags: BTreeMap<String, String>,
    pub session_id: String,
}

impl SavfoxLogSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("savfox-feedback-{}.log", self.session_id);
    ...
    pub fn upload_feedback(
        ...
        let mut tags = BTreeMap::from([
            (String::from("session_id"), self.session_id.to_string()),
        ...
        if include_logs {
            envelope.add_item(EnvelopeItem::Attachment(Attachment {
                ...
                filename: String::from("savfox-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = SavfoxFeedback::with_capacity(8);
        {
