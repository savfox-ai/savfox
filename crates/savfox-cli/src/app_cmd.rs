...
const DEFAULT_SAVFOX_DMG_URL: &str = "https://persistent.oaistatic.com/savfox-app-prod/Savfox.dmg";

#[derive(Debug, Parser)]
pub struct AppCommand {
    /// Workspace path to open in Savfox Desktop.
    #[arg(value_name = "PATH", default_value = ".")]
    pub path: PathBuf,

    /// Override the macOS DMG download URL (advanced).
    #[arg(long, default_value = DEFAULT_SAVFOX_DMG_URL)]
