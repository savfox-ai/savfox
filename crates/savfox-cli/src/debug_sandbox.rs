...
use savfox_core::spawn::StdioPolicy;
...
pub async fn run_command_under_seatbelt(
    ...
    _savfox_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.savfox_home.clone();
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let savfox_linux_sandbox_exe = config
                .savfox_linux_sandbox_exe
                .expect("savfox-linux-sandbox executable not found");
