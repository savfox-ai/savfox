...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = savfox_utils::cargo_bin::cargo_bin("savfox-mcp-server")
            .context("should find binary for savfox-mcp-server")?;
    ...
    pub async fn initialize(&mut self) -> anyhow::Result<()> {
        ...
        let originator = savfox_core::default_client::originator().value;
    ...
    pub async fn send_savfox_tool_call(
        &mut self,
    ...
    /// Method "savfox/event" with params.msg.type == "task_complete".
        ...
        loop {
            ...
            match message {
                JsonRpcMessage::Notification(notification) => {
                    let is_match = if notification.notification.method == "savfox/event" {
