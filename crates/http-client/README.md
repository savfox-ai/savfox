...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Savfox/OpenAI awareness.
...
- Consumed by higher-level crates like `savfox-api-client`; it stays neutral on endpoints, headers, or API-specific error shapes.
