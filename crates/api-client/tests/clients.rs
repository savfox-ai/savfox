...
use savfox_api_client::{
    AuthProvider, ChatClient, Provider, ResponsesClient, ResponsesOptions, WireApi,
};
use savfox_http_client::{HttpTransport, Request, Response, StreamResponse, TransportError};
...
fn provider(name: &str, wire: WireApi) -> Provider {
    Provider {
        ...
        wire,
        headers: HeaderMap::new(),
        retry: savfox_api_client::provider::RetryConfig {
            max_attempts: 1,
