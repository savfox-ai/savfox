...
use savfox_http_client::{HttpTransport, RequestCompression, RequestTelemetry, StreamResponse};
...
impl<T: HttpTransport, A: AuthProvider> StreamingClient<T, A> {
    ...
    pub(crate) async fn stream(
        ...
        let _body_pretty = serde_json::to_string_pretty(&body).unwrap_or_else(|_| body.to_string());
