...
//! `schemars`) so they can be embedded in Savfox's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `savfox-protocol` so other crates can convert
