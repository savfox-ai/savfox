    ...
    rsx! {
        div { class: "overview-page",
            ...
            div { class: "stats-grid",
                ...
                { stat_card("Tokens Used", &total_tokens) }
                        ...
                        for ch in channel_health.iter() {
                            {
                                ...
                                rsx! {
                                    div { class: "ov-channel-card",
                                        div { class: "ov-channel-icon", "{ch.icon}" }
            ...
            div { class: "card",
                ...
                div { class: "quick-links",
                    { quick_link("Session", "/sessions") }
                    { quick_link("Agents", "/agents") }
                    { quick_link("Memory", "/memory") }
                    { quick_link("Channels", "/channels") }
                    { quick_link("Config", "/config") }
                    { quick_link("Cron", "/cron") }
                    { quick_link("Logs", "/logs") }
                    { quick_link("Usage", "/usage") }
                    { quick_link("Approvals", "/approvals") }
                    { quick_link("Nodes", "/nodes") }
                    { quick_link("Skills", "/skills") }
                    { quick_link("Instances", "/instances") }
                    { quick_link("Debug", "/debug") }
                }
            }
        }
        style { {STYLE} }
...
fn quick_link(label: &str, href: &str) -> Element {
    rsx! {
        a { href: "{href}", class: "quick-link", "{label}" }
    }
}
