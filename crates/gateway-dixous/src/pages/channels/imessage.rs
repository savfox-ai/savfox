...
#[component]
pub fn IMessageChannel() -> Element {
    let ws = use_context::<Signal<WsRpc>>();
    let mut status = use_signal(|| None::<IMessageStatus>);
    ...
    let load_status = move || {
        ...
        async move {
            ...
            let result = ws
                ...
                .call::<IMessageStatus>(
                    "channels.status",
                    Some(serde_json::json!({"channel": "imessage"})),
                )
                .await;
                    ...
                    div { class: "channels-card",
                        div { class: "channels-card__header",
                            div { class: "channels-card__identity",
                                div { class: "channels-card__name", "iMessage" }
                            }
                                ...
                                button {
                                    ...
                                    onclick: move |_| {
                                        ...
                                        async move {
                                            ...
                                            let _ = ws.read()
                                                .call::<serde_json::Value>("channels.logout", Some(serde_json::json!({"channel": "imessage"})))
                                                .await;
                                ...
                                button {
                                    ...
                                    onclick: move |_| {
                                        ...
                                        async move {
                                            action_loading.set(true);
                                            let _ = ws.read()
                                                .call::<serde_json::Value>("channels.login", Some(serde_json::json!({"channel": "imessage"})))
                                                .await;
                                            action_loading.set(false);
                                            load_status().await;
                                        }
