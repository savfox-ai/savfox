...
#[component]
pub fn GoogleChatChannel() -> Element {
    let ws = use_context::<Signal<WsRpc>>();
    let mut status = use_signal(|| None::<GoogleChatStatus>);
    ...
    let load_status = move || {
        ...
        async move {
            ...
            let result = ws
                .read()
                .call::<GoogleChatStatus>(
                    "channels.status",
                    Some(serde_json::json!({"channel": "googlechat"})),
                )
                .await;
            ...
            div { class: "channels-toolbar",
                div { class: "channels-toolbar__left",
                    h2 { class: "channels-toolbar__title",
                        span { class: "channel-icon", dangerous_inner_html: crate::utils::icons::ICON_GOOGLE_CHAT }
                        "Google Chat"
                    }
                    p { class: "channels-toolbar__subtitle", "Chat API webhook status and channel configuration." }
                }
            }
                    ...
                    div { class: "channels-card",
                        div { class: "channels-card__header",
                            div { class: "channels-card__identity",
                                div { class: "channels-card__name", "Google Chat" }
                            }
                                ...
                                button {
                                    ...
                                    onclick: move |_| {
                                        ...
                                        async move {
                                            ...
                                            let _ = ws.read()
                                                .call::<serde_json::Value>("channels.logout", Some(serde_json::json!({"channel": "googlechat"})))
                                                .await;
                                ...
                                button {
                                    ...
                                    onclick: move |_| {
                                        ...
                                        async move {
                                            action_loading.set(true);
                                            let _ = ws.read()
                                                .call::<serde_json::Value>("channels.login", Some(serde_json::json!({"channel": "googlechat"})))
                                                .await;
                                            action_loading.set(false);
                                            load_status().await;
                                        }
