...
use savfox_app_server_protocol::{
    AppsListParams, CancelLoginAccountParams, ClientInfo, ClientNotification,
    CollaborationModeListParams, ConfigBatchWriteParams, ConfigReadParams, ConfigValueWriteParams,
    FeedbackUploadParams, GetAccountParams, InitializeCapabilities, InitializeParams, JSONRPCError,
    JSONRPCErrorError, JSONRPCNotification, JSONRPCRequest, JSONRPCResponse, JsonRpcMessage,
    LoginAccountParams, MockExperimentalMethodParams, ModelListParams, RequestId,
    ReviewStartParams, ServerRequest, SessionArchiveParams, SessionForkParams, SessionListParams,
    SessionLoadedListParams, SessionReadParams, SessionResumeParams, SessionRollbackParams,
    SessionStartParams, SessionUnarchiveParams, TurnInterruptParams, TurnStartParams,
};
...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = savfox_utils::cargo_bin::cargo_bin("savfox-app-server")
