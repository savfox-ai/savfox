    ...
    "data": [
        {
            ...
            "installUrl": "https://taidge.com/apps/demo-app/demo-app",
            "isAccessible": true
        }
    ],
    "nextCursor": null
...
1. Start:
   ...
   { "id": 3, "result": { "type": "chatgpt", "loginId": "<uuid>", "authUrl": "https://taidge.com/…&redirect_uri=http%3A%2F%2Flocalhost%3A<port>%2Fauth%2Fcallback" } }
   ```
