...
impl SkillRegistry {
    ...
    pub async fn load(&self) {
        if let Ok(Some(installed)) = crate::json_store::load_json_opt::<
            HashMap<String, InstalledSkill>,
        >(&self.installed_path, "skill registry")
        .await
        {
    ...
    async fn save(&self) -> Result<(), String> {
        ...
        crate::json_store::save_json(&self.installed_path, &*installed, "skill registry").await
    }
