...
/// Send a request and parse the JSON response, returning a unified error on failure.
async fn send_json_request(request: reqwest::RequestBuilder) -> MediaResult<serde_json::Value> {
