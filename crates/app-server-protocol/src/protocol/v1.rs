...
use savfox_protocol::protocol::{
    AskForApproval, EventMsg, FileChange, ReviewDecision, SandboxPolicy, SessionSource,
    TurnAbortReason,
};
use savfox_protocol::user_input::{ByteRange as CoreByteRange, TextElement as CoreTextElement};
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: SessionId,
    /// Use to correlate this with [savfox_core::protocol::PatchApplyBeginEvent]
    /// and [savfox_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
