...
client_request_definitions! {
    ...
    SessionResume => "session/resume" {
        params: v2::SessionResumeParams,
        response: v2::SessionResumeResponse,
    },
    SessionFork => "session/fork" {
        params: v2::SessionForkParams,
        response: v2::SessionForkResponse,
    },
    SessionArchive => "session/archive" {
        params: v2::SessionArchiveParams,
        response: v2::SessionArchiveResponse,
    },
    SessionSetName => "session/name/set" {
        params: v2::SessionSetNameParams,
        response: v2::SessionSetNameResponse,
    },
    SessionUnarchive => "session/unarchive" {
        params: v2::SessionUnarchiveParams,
        response: v2::SessionUnarchiveResponse,
    },
    SessionRollback => "session/rollback" {
        params: v2::SessionRollbackParams,
        response: v2::SessionRollbackResponse,
    },
    SessionList => "session/list" {
        params: v2::SessionListParams,
        response: v2::SessionListResponse,
    },
    SessionLoadedList => "session/loaded/list" {
        params: v2::SessionLoadedListParams,
        response: v2::SessionLoadedListResponse,
    },
    SessionRead => "session/read" {
        params: v2::SessionReadParams,
        response: v2::SessionReadResponse,
    },
    ...
    /// List recorded Savfox conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded Savfox conversation from a rollout file.
    ResumeConversation {
        params: v1::ResumeConversationParams,
        response: v1::ResumeConversationResponse,
    },
    /// Fork a recorded Savfox conversation into a new session.
    ForkConversation {
...
server_notification_definitions! {
    ...
    SessionStarted => "session/started" (v2::SessionStartedNotification),
    SessionNameUpdated => "session/name/updated" (v2::SessionNameUpdatedNotification),
    SessionTokenUsageUpdated => "session/tokenUsage/updated" (v2::SessionTokenUsageUpdatedNotification),
    ...
    ContextCompacted => "session/compacted" (v2::ContextCompactedNotification),
