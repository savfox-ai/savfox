...
use crate::default_client::{SavfoxHttpClient, SavfoxRequestBuilder};
use crate::error::TransportError;
use crate::request::{Request, RequestCompression, Response};
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: SavfoxHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<SavfoxRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
