...
use super::selection_popup_common::{
    GenericDisplayRow, measure_rows_height, render_menu_surface, render_rows, wrap_styled_line,
};
...
mod tests {
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between Savfox approval presets"));
