...
use super::selection_popup_common::{GenericDisplayRow, render_rows_single_line};
use crate::app_event::AppEvent;
use crate::app_event_sender::AppEventSender;
use crate::key_hint;
use crate::render::renderable::{ColumnRenderable, Renderable};
use crate::render::{Insets, RectExt as _};
use crate::skills_helpers::{match_skill, truncate_skill_name};
...
impl SkillsToggleView {
    ...
    fn close(&mut self) {
        ...
        self.app_event_tx.send(AppEvent::SavfoxOp(Op::ListSkills {
            cwds: Vec::new(),
            force_reload: true,
        }));
    }
