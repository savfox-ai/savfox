...
use savfox_core::{AuthManager, WireApi};
...
use super::rate_limits::{
    RateLimitSnapshotDisplay, StatusRateLimitData, StatusRateLimitRow, StatusRateLimitValue,
    compose_rate_limit_data, format_status_limit_summary, render_status_limit_progress_bar,
};
...
impl HistoryCell for StatusHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        lines.push(Line::from(vec![
            ...
            Span::from(" ").dim(),
            Span::from(format!("(v{SAVFOX_CLI_VERSION})")).dim(),
        ]));
        ...
        let note_first_line = Line::from(vec![
            ...
            "https://taidge.com/savfox/settings/usage"
                .cyan()
                .underlined(),
