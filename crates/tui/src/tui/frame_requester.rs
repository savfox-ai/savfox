...
mod tests {
    ...
    async fn test_coalesces_mixed_immediate_and_delayed_requests() {
        ...
        // Schedule a delayed draw and then an immediate one; should coalesce and fire at the
        // earliest (immediate).
        ...
        // The later delayed request should have been coalesced into the earlier one; no second
        // draw.
