...
// const PAID_TOOLTIP: &str = "*New* Try the **Savfox App** with 2x rate limits until *April 2nd*. Run 'savfox app' or visit https://taidge.com/savfox";
// const OTHER_TOOLTIP: &str = "*New* Build faster with the **Savfox App**. Run 'savfox app' or visit https://taidge.com/savfox";
// const FREE_GO_TOOLTIP: &str =
//     "*New* Savfox is included in your plan for free through *March 2nd* – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Savfox.
...
pub(crate) mod announcement {
    ...
    pub(crate) fn prewarm() {
        let _ = thread::spawn(|| ANNOUNCEMENT_TIP.get_or_init(init_announcement_tip_in_session));
    }
    ...
    fn init_announcement_tip_in_session() -> Option<String> {
    ...
    pub(crate) fn parse_announcement_tip_toml(text: &str) -> Option<String> {
        ...
        for raw in announcements {
            ...
            if tip.version_matches(SAVFOX_CLI_VERSION)
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Savfox TUI.
...
[[announcements]]
content = "Welcome to Savfox! Check out the new onboarding flow."
