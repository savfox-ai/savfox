...
// const PAID_TOOLTIP: &str = "*New* Try the **Savfox App** with 2x rate limits until *April 2nd*. Run 'savfox app' or visit https://savfox.ai/savfox";
// const OTHER_TOOLTIP: &str = "*New* Build faster with the **Savfox App**. Run 'savfox app' or visit https://savfox.ai/savfox";
