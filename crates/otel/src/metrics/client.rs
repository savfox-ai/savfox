...
use opentelemetry_otlp::{
    OTEL_EXPORTER_OTLP_METRICS_TIMEOUT, Protocol, WithExportConfig, WithHttpConfig, WithTonicConfig,
};
...
use crate::config::{OtelExporter, OtelHttpProtocol};
use crate::metrics::config::{MetricsConfig, MetricsExporter};
use crate::metrics::timer::Timer;
use crate::metrics::validation::{
    validate_metric_name, validate_tag_key, validate_tag_value, validate_tags,
};
use crate::metrics::{MetricsError, Result};

const ENV_ATTRIBUTE: &str = "env";
const METER_NAME: &str = "savfox";
...
/// OpenTelemetry metrics client used by Savfox.
#[derive(Clone, Debug)]
