...
/// Top-level JSONL events emitted by savfox exec
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, TS)]
#[serde(tag = "type")]
pub enum SessionEvent {
    /// Emitted when a new session is started as the first event.
    ...
    /// Emitted when a new item is added to the session. Typically the item will be in an "in
    /// progress" state.
...
pub struct SessionStartedEvent {
    /// The identified of the new session. Can be used to resume the session later.
...
/// Canonical representation of a session item and its domain-specific payload.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, TS)]
pub struct SessionItem {
    pub id: String,
    #[serde(flatten)]
    pub details: SessionItemDetails,
}

/// Typed payloads for each supported session item type.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, TS)]
#[serde(tag = "type", rename_all = "snake_case")]
pub enum SessionItemDetails {
